...
class DDR5
{
  ...
  protected:  
    ...
    {
    // rate   nBL  nCL  nRCD  nRP   nRAS  nRC   nWR  nRTP nCWL nPPD nCCDS nCCDL nCCDLwr nCCDLwr2 nRRDS nRRDL nWTRS nWTRL nFAW  nRFC nRFCsb nREFI  nRFM,   nREFSBRD,   nPD nXP nCKESR nXS, nRTRS, tCK_ps
      {3200,   8,  22,  22,   22,   52,   74,   48,   12,  20,  2,    4,    8,     32,      16,     -1,   -1,    4,    16,  -1,  -1,    -1,   -1,   -1,         -1,   8,  10,   9,  -1,   -1,    625},   // 3200A
    }; 
    ...
    {
      //8Gb   16Gb   24Gb  32Gb
      { 195,  295,  410,  410}, // Normal refresh (tRFC1)
      { 130,  160,  220,  220}, // REFab fine granularity (tRFC2)
      { 115,   130,  190,  190}, // REFsb (tRFCsb)
    };
    // tREFI(ab) table (unit is nanosecond!)
    static constexpr int REFI_AB_TABLE[4] =
    //8Gb   16Gb   24Gb  32Gb
    {   3900, 3900, 3900, 3900 };

    // tREFI(ab-fine) table (unit is nanosecond!)
    static constexpr int REFI_AB_FINE_TABLE[4] =
    //8Gb   16Gb   24Gb  32Gb
    {   1950, 1950, 1950, 1950 };
