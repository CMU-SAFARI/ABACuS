...
class DDR4
{
  public:
    ...
    {
      ACT, PRE, PREab,
      ACTvrr, // victim row refresh activation
      RD,  WR,  RDA,  WRA,
      REF, PDE, PDX,  SRE, SRX,
      MAX
    };
    ...
    {
      Opened, Closed, ClosedPending, PowerUp, ActPowerDown, PrePowerDown, SelfRefresh, OpenedVictimRefresh, MAX
    };
