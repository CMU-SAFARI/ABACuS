...
namespace Ramulator
{
  class Window 
  {
    ...
    private:
      ...
      ScalarStat top_of_window_latency;
      long top_of_window_since = 0;

    public:
      Window() : ready_list(depth), addr_list(depth, -1) {};

      void init_stat(int core_id);
    ...
    public:
      ...
      long retire();
      void set_ready(long addr, int mask, long depart, long arrive);
  };
  ...
  class Core 
  {
    public:
      ...
      ScalarStat window_full_stall_cycles;
    ...
    private:
      ...
      ScalarStat memory_access_cycles_avg;
      ScalarStat cpu_inst;
      MemoryBase* memory;
  };
