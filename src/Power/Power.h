...
namespace Ramulator
{
  ...
  class Power
  {
    ...
    public:
      void handle_ACT_rank(bool is_rank_idle, int64_t clk, int act_multiplier);
      void handle_ACT_bank(int64_t clk, int act_multiplier);

      void handle_PRE_rank(bool is_rank_idle, int64_t clk, int pre_multiplier);
      void handle_PRE_bank(int64_t clk, int pre_multiplier);
